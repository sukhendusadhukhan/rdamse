...
const SurTechLogo = () => (
  <div className="relative flex items-center justify-center">
    <div className="relative w-12 h-14 md:w-16 md:h-16 bg-white rounded-lg overflow-hidden shadow-md border border-[#0056b3]/30 flex items-center justify-center">
      <svg viewBox="0 0 100 120" className="w-full h-full p-2" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M75 35 C75 25 65 20 50 20 C35 20 25 25 25 35 C25 45 35 50 50 55 C65 60 75 65 75 75 C75 85 65 90 50 90 C35 90 25 85 25 75" stroke="#0056b3" strokeWidth="12" strokeLinecap="round" />
        <path d="M75 35 C75 25 65 20 50 20 C35 20 25 25 25 35 C25 45 35 50 50 55 C65 60 75 65 75 75 C75 85 65 90 50 90 C35 90 25 85 25 75" stroke="#f2a900" strokeWidth="6" strokeLinecap="round" />
      </svg>
    </div>
  </div>
);
...
const prevYearsData = [
  ...
  {
    year: "2025",
    edition: "IC-RDAMSE 2025",
    date: "30th – 31st January 2025",
    theme: "Recent Developments and Applications in Materials Science and Engineering",
    description:
      "Held in Kolkata in association with Indian Photobiology Society & Jadavpur University. The conference addressed key SDGs — Clean Water & Sanitation, Affordable & Clean Energy, and Climate Action — bringing researchers from across the globe to share knowledge, innovations and policy frameworks for global progress.",
    highlights: ["Materials Science & SDGs", "Indian Photobiology Society", "Jadavpur University", "Kolkata, India"],
    img: clgImg,
    alt: "IC-RDAMSE 2025 — SurTech Campus",
    accent: "#047857",
  },
  {
    year: "2026",
    edition: "2nd IC-RDAMSE",
    date: "7th – 8th May 2026",
    theme: "Emerging Trends in Data Science, AI & Sustainable Engineering",
    highlights: ["200+ Papers Expected", "30+ Countries", "10 Keynote Speakers"],
    img: flyerImg,
    alt: "2nd IC-RDAMSE 2026 — Official Flyer",
    accent: "#b8f29d",
  },
];
...
const eventMoments = [
  {
    ...
    description: "Scholars from over 30 countries sharing groundbreaking research and innovative ideas.",
    img: event1,
    accent: "#059669",
  ...
  },
  {
    ...
    description: "In-depth technical sessions exploring the frontiers of engineering and data science.",
    img: event2,
    accent: "#047857",
    tag: "Research Depth"
  },
  {
    ...
    description: "Industry pioneers and academic leaders delivering visionary talks on sustainable technology.",
    img: event3,
    accent: "#065f46",
    tag: "Future Vision"
  },
  {
    ...
    description: "Fostering academic-industry collaborations to drive real-world impact and development.",
    img: event4,
    accent: "#064e3b",
    tag: "Industry Impact"
  },
  {
    title: "Awarding Achievement",
    description: "Recognizing outstanding research contributions and young investigators in our community.",
    img: event5,
    accent: "#b8f29d",
    tag: "Excellence"
  },
